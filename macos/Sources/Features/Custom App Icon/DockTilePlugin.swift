...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.sarv.terminal.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.sarv.terminal")
    #endif
