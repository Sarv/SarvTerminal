...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            "workspace:toggle_ssh_manager",
            "Open SSH Manager",
            WorkspaceAction::ToggleSshManager,
        )
        .with_context_predicate(id!("Workspace"))
        .with_enabled(|| FeatureFlag::SshManager.is_enabled()),
        EditableBinding::new(
            "workspace:toggle_sync_settings",
            "Open Sync Settings",
            WorkspaceAction::ToggleSyncManager,
        )
        .with_context_predicate(id!("Workspace"))
        .with_enabled(|| FeatureFlag::SyncManager.is_enabled()),
        EditableBinding::new(
            "workspace:sync_push",
            "Sync: Push Local Settings to Remote",
            WorkspaceAction::SyncPushToRemote,
        )
        .with_context_predicate(id!("Workspace"))
        .with_enabled(|| FeatureFlag::SyncManager.is_enabled()),
        EditableBinding::new(
            "workspace:sync_pull",
            "Sync: Pull Settings from Remote",
            WorkspaceAction::SyncPullFromRemote,
        )
        .with_context_predicate(id!("Workspace"))
        .with_enabled(|| FeatureFlag::SyncManager.is_enabled()),
    ]);
