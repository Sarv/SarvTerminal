...
use super::{conversations, ssh, warp_drive};
...
pub struct DataSourceStore {
    ...
    ssh_data_source: ModelHandle<ssh::DataSource>,
...
impl DataSourceStore {
    pub fn new(
        ...
        let ssh_data_source = ctx.add_model(|_| ssh::DataSource::new());
