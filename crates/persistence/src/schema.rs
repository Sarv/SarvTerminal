...
diesel::table! {
    sync_config (id) {
        ...
        last_sync_direction -> Nullable<Text>,
        pat_enc -> Text,
        master_pass_enc -> Text,
    }
}
...
diesel::joinable!(ssh_hosts -> ssh_groups (group_id));
diesel::allow_tables_to_appear_in_same_query!(ssh_groups, ssh_hosts,);
